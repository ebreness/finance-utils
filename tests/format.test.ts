...
Deno.test('formatCentsToNumber - validation errors', () => {
  ...
  assertThrows(() => formatCentsToNumber(null), Error, 'cannot be null or undefined');
  // @ts-ignore - Testing invalid input types
  assertThrows(() => formatCentsToNumber(undefined), Error, 'cannot be null or undefined');
});
...
Deno.test('formatCentsWithCurrency - validation errors', () => {
  ...
  // @ts-ignore - Testing invalid input types
  assertThrows(() => formatCentsWithCurrency(null), Error, 'cannot be null or undefined');
  // @ts-ignore - Testing invalid input types
  assertThrows(() => formatCentsWithCurrency(undefined), Error, 'cannot be null or undefined');
});
